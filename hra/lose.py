...
class Lose:
    ...
    def draw_cursor(self):
        ...
        cursor = pygame.Surface((self.cursor_radius * 2, self.cursor_radius * 2), pygame.SRCALPHA)
        pygame.draw.circle(cursor, self.cursor_color + (self.cursor_alpha,), (self.cursor_radius, self.cursor_radius), self.cursor_radius)
        self.screen.blit(cursor, (mouse_pos[0] - self.cursor_radius, mouse_pos[1] - self.cursor_radius))
        pygame.draw.circle(self.screen, self.cursor_color, mouse_pos, self.cursor_radius, 0)
